...
class DetectObjectsNode(Node):
    def __init__(self, node_name='detect_objects_node'):
        ...
        self._logger.info(f"Detect Objects node started")
    ...
    def image_callback(self, msg: Image):
            ...
            if self.T_world_cam is None:
                ...
                self.T_world_cam[0:3, 0:3] = R.from_quat([q.x, q.y, q.z, q.w]).as_matrix()
                self.T_world_cam[0:3, 3] = [t.x, t.y, t.z]
            ...
            if ids is not None:
                ...
                for i, detected_marker_id in enumerate(ids.flatten()):
                    # Skip world marker
                    if detected_marker_id == self.world_marker_id:
                        continue
                    ...
                    T_world_marker = self.T_world_cam @ T_cam_marker
